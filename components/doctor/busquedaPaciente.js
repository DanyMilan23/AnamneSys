                    ...
                    <Paper className={classes.paper} elevation={3}>
                      ...
                      >
                        <Grid item xs={12} sm={8}>
                          ...
                          <p>
                            <b>Presion Arterial:</b>
                            {seleccion.patient.blood_pressure}
                          </p>
                          <p>
                            <b>Frecuencia Cardiaca:</b>{" "}
                            {seleccion.patient.breathing_frequency.inicio} -{" "}
                            {seleccion.patient.breathing_frequency.fin}
                          </p>
                          <p>
                            <b>Ritmo Caridaco:</b>{" "}
                            {seleccion.patient.heart_rate.inicio} -{" "}
                            {seleccion.patient.heart_rate.fin}
                          </p>
                          <p>
                            <b>Temperatura:</b>
                            {seleccion.patient.temperature} C
                          </p>
                        </Grid>
