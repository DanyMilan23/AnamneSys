  ...
  constructor(props) {
    ...
    this.state = {
      columns: [
        ...
        { title: "Tipo Doctor", field: "tipo_doctor" },
      ...
      .then((querySnapshot) => {
        ...
        querySnapshot.forEach(function (doc) {
          ...
          salida.push({
            ...
            email: doc.data().doctor.email,
            password: doc.data().doctor.password,
            tipo_doctor: doc.data().doctor.doctor_type.name,
          });
        });
        console.log(salida);
        this.setState({
